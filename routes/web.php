...
Route::post('/order/{order}/confire', [OrderController::class, 'confirm_payment'])->name('confirm_payment');

Route::get('/profile', [ProfileController::class, 'show_profile'])->name('show_profile');
Route::post('/porfile', [ProfileController::class, 'edit_profile'])->name('edit_profile');
